/* @ds-bundle: {"format":3,"namespace":"DesignSystem_220107","components":[],"sourceHashes":{"assets/chp-paginate.js":"23135b496af8"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.DesignSystem_220107 = window.DesignSystem_220107 || {});

const __ds_scope = {};

(__ds_ns.__errors = __ds_ns.__errors || []);

// assets/chp-paginate.js
try { (() => {
/*
...
function initChpPaginator({
  ...
  if (current && current.length) pages.push({
    label: currentLabel,
    els: current
  });
  ...
  return {
    goTo,
    pageCount: pageDivs.length
  };
}
})(); } catch (e) { __ds_ns.__errors.push({ path: "assets/chp-paginate.js", error: String((e && e.message) || e) }); }
